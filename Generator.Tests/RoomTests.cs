...
namespace Generator.Tests
{
	...
	public class RoomTests
	{
		...
		[Test, TestCase(0, 0), TestCase(-1, 0), TestCase(0, -1), TestCase(1, -1), TestCase(-1, 1)]
		...
		[Test, TestCase(4, 5), TestCase(4, 3), TestCase(5, 4), TestCase(3, 4), TestCase(3, 3), TestCase(5, 5)]
		...
		[Test, TestCase(-1, 0), TestCase(0, -1), TestCase(-1, -1), TestCase(4, 0), TestCase(0, 4), TestCase(4, 4)]
